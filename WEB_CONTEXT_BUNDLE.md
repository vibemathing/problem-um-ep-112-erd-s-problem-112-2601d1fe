...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-112-erd-s-problem-112-2601d1fe-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-112"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-112-erd-s-problem-112-2601d1fe-v1",
      "problem_contract_sha256": "d2b91e5222f501bc01decdf7f024db559b59b94394210d92a6228b497258ed71",
      "problem_id": "problem:um-ep-112-erd-s-problem-112-2601d1fe",
      "route_id": "route:um-ep-112-erd-s-problem-112-2601d1fe-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-112-erd-s-problem-112-2601d1fe-source-fidelity-01",
      "graph_id": "graph:um-ep-112-erd-s-problem-112-2601d1fe-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-112-erd-s-problem-112-2601d1fe-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-112-erd-s-problem-112-2601d1fe-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $k=k(n,m)$ be minimal such that any directed graph on $k$ vertices must contain either an independent set of size $n$ or a transitive tournament of size $m$. Determine $k(n,m)$."
          },
          "statement_sha256": "5c4f5e559f413b709f94817fdb36791cc9f8d5348d60e5d5f5588e5e2f1b91fc"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-112-erd-s-problem-112-2601d1fe-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-112-erd-s-problem-112-2601d1fe-root",
      "route_id": "route:um-ep-112-erd-s-problem-112-2601d1fe-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Number Theory problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-112-03ea98a82246",
        "url": "https://www.unsolvedmath.com/problems/EP-112"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
